...
public class PartEditor extends JPanel {
    ...
    public PartEditor() {
        this(new ParamNTGC((new ParameterMap()).construct(0, 6, new double[] {
            2.0, 3.0, 4.0, 6.0, 8.0, 12.0, 16.0 }, 4.0, "scope")));
    }

    public PartEditor(Part p) {
        this(new ParamNTGC((new ParameterMap()).construct(0, 6, new double[] {
            2.0, 3.0, 4.0, 6.0, 8.0, 12.0, 16.0 }, 4.0, "scope")), p);
    }
        ...
        ActionListener al = new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                if (e.getSource() == inst) {
                    ...
                    // inst " +
                    // ((NumberTextField)e.getSource()).getValue());
                    ...
                    part.setTitle(titleField.getText());
    ...
    private void makeLabView(ParameterMap pm, Box b, String toolText, 
            Dimension dim) {
        LabelledView lv = (new LabelledView()).construct(pm, true,
            true, toolText, 0);
    ...
    public void setScope(ParameterMap nscope) {
        ...
        this.scope = nscope;
        pnpanel.setScope(nscope); // updates the converter as well
    ...
    public void setQuantise(ParameterMap nquant) {
        ...
        pnpanel.setQuantise(nquant); // updates the converter as well
