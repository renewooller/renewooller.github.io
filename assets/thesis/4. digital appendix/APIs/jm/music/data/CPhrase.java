...
public class CPhrase implements JMC, Cloneable, Serializable{
	...
	*/
	public double getEndTime(){	
		...
		Enumeration enumr = this.phraseList.elements();
		while(enumr.hasMoreElements()){
			Phrase nextPhr = (Phrase)enumr.nextElement();
	...
	*/
	public CPhrase copy(){
		...
		Enumeration enumr = this.phraseList.elements();
		while(enumr.hasMoreElements()){
			Phrase ph = ((Phrase) enumr.nextElement()).copy();
	...
	*/
	public CPhrase copy(double startLoc, double endLoc){
		...
		Enumeration enumr = this.phraseList.elements();
		while(enumr.hasMoreElements()){
			Phrase ph = ((Phrase) enumr.nextElement()).copy(startLoc, endLoc);
			ph.setStartTime(0.0);
			tempVect.addElement(ph);			
		}
		cp.setPhraseList(tempVect);
        ...
        */
        public void flam(final double offsetAmount){
            ...
            while(enumr.hasMoreElements()){
                ...
                Enumeration enumr2 = phr.getNoteList().elements();
